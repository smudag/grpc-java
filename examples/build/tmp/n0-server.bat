...
@rem ##########################################################################
@rem
@rem  n0-server startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and N0_SERVER_OPTS to pass JVM options to this script.
...
@rem Execute n0-server
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %N0_SERVER_OPTS%  -classpath "%CLASSPATH%" io.grpc.examples.helloworld.N0Server %*
...
:fail
rem Set variable N0_SERVER_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%N0_SERVER_EXIT_CONSOLE%" exit 1
exit /b 1
