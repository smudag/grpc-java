...
@rem ##########################################################################
@rem
@rem  retrying-hello-world-server startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and RETRYING_HELLO_WORLD_SERVER_OPTS to pass JVM options to this script.
...
@rem Execute retrying-hello-world-server
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %RETRYING_HELLO_WORLD_SERVER_OPTS%  -classpath "%CLASSPATH%" io.grpc.examples.retrying.RetryingHelloWorldServer %*
...
:fail
rem Set variable RETRYING_HELLO_WORLD_SERVER_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%RETRYING_HELLO_WORLD_SERVER_EXIT_CONSOLE%" exit 1
exit /b 1
