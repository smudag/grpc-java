...
@rem ##########################################################################
@rem
@rem  hedging-hello-world-server startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and HEDGING_HELLO_WORLD_SERVER_OPTS to pass JVM options to this script.
...
@rem Execute hedging-hello-world-server
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %HEDGING_HELLO_WORLD_SERVER_OPTS%  -classpath "%CLASSPATH%" io.grpc.examples.hedging.HedgingHelloWorldServer %*
...
:fail
rem Set variable HEDGING_HELLO_WORLD_SERVER_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%HEDGING_HELLO_WORLD_SERVER_EXIT_CONSOLE%" exit 1
exit /b 1
