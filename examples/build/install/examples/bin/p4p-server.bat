...
@rem ##########################################################################
@rem
@rem  p4p-server startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and P4P_SERVER_OPTS to pass JVM options to this script.
...
@rem Execute p4p-server
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %P4P_SERVER_OPTS%  -classpath "%CLASSPATH%" io.grpc.examples.p4p.p4p.server.P4PServerSS %*
...
:fail
rem Set variable P4P_SERVER_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%P4P_SERVER_EXIT_CONSOLE%" exit 1
exit /b 1
