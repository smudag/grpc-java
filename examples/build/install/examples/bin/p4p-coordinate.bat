...
@rem ##########################################################################
@rem
@rem  p4p-coordinate startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and P4P_COORDINATE_OPTS to pass JVM options to this script.
...
@rem Execute p4p-coordinate
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %P4P_COORDINATE_OPTS%  -classpath "%CLASSPATH%" io.grpc.examples.p4p.p4p.sim.P4PCoordinate %*
...
:fail
rem Set variable P4P_COORDINATE_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%P4P_COORDINATE_EXIT_CONSOLE%" exit 1
exit /b 1
